...
public class AppWidget extends AppWidgetProvider {
	private static final String PLAY_ACTION = "music.dreamer.playmusic";
	private static final String NEXT_ACTION = "music.dreamer.nextone";
	private static final String lAST_ACTION = "music.dreamer.lastone";
	private static final String START_APP = "music.dreamer.startapp";
	@Override
